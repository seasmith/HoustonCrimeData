...
links_pre_2017 <- str_replace(links_pre_2017, "^/police/cs/", "")

base <- "http://www.houstontx.gov/police/cs/"

links_pre_2017_excel <- paste0(base, links_pre_2017)

dest <- "data/hou_crime_data"
dest_paths <- paste0(dest, str_replace(links_pre_2017, "^xls", ""))

## Download

hou_cr_dwnld <- links_pre_2017_excel %>%
...
## Download
hou_cr_dwnld_2017 <- map2(links_excel, dest_paths2, ~curl_download(.x, .y, mode = "wb"))
